# From https://github.com/nhammerla/deepHAR in reference to the Hammerla paper https://arxiv.org/pdf/1604.08880.pdf
...
class data_reader:
    ...
    def save_data(self):
        ...
        f.close()
        with open('dg.h5.classes.json', 'w') as f:
    ...
    def _read_opportunity(self, datapath):
        files = {
            'training': [
                'S01R01.txt', 'S01R02.txt', 'S03R01.txt', 'S03R03.txt', 'S04R01.txt', 'S05R01.txt', 'S06R01.txt',
                'S06R02.txt', 'S07R01.txt', 'S08R01.txt', 'S10R01.txt'
            ],
            'validation': [
                'S09R01.txt'
            ],
